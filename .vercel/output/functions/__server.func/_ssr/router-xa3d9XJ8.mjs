...
import { i as useMusic, n as formatTime, t as MusicProvider } from "./MusicProvider-XuC0OULW.mjs";
...
import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-yn80w72V.mjs";
import { a as stringType, i as objectType, n as enumType, r as literalType, t as booleanType } from "../_libs/zod.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-xa3d9XJ8.js
var import_mongoose = /* @__PURE__ */ __toESM(require_mongoose());
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-B6aaLOo8.css";
...
var $$splitComponentImporter$8 = () => import("./routes-t6enx1Qr.mjs");
...
var $$splitComponentImporter$7 = () => import("./admin-CRdihfdt.mjs");
...
var $$splitComponentImporter$5 = () => import("./letters-DLnxkZAS.mjs");
...
var $$splitComponentImporter$3 = () => import("./photos-ByFR-mQu.mjs");
...
var $$splitComponentImporter$2 = () => import("./songs-Bq_HJSTz.mjs");
...
var $$splitComponentImporter = () => import("./videos-fSBy0Y9p.mjs");
...
var Route$8 = createFileRoute("/api/media/upload")({ server: { handlers: { POST: async ({ request }) => {
	...
	try {
		...
		const rawCoverFileId = formData.get("coverFileId");
		const coverFileId = rawCoverFileId && import_mongoose.default.Types.ObjectId.isValid(rawCoverFileId) ? new import_mongoose.default.Types.ObjectId(rawCoverFileId) : void 0;
		const rawStartTime = formData.get("startTime");
		...
		const mediaItem = new MediaItem({
			...
			description,
			duration: duration || (type === "video" ? "0:30" : type === "song" ? "3:00" : void 0),
			filename: validation.safeFilename,
