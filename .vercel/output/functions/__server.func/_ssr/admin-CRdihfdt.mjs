...
import { i as uploadMediaInChunks, n as formatUploadError, r as readJsonResponse, t as compressImage } from "./api-D5R3uvKX.mjs";
import { a as require_jsx_runtime, i as useQueryClient, n as useQuery, o as require_react, t as useMutation } from "../_libs/react+tanstack__react-query.mjs";
import { r as parseDuration } from "./MusicProvider-XuC0OULW.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/admin-CRdihfdt.js
...
function PhotosManager({ photos, isLoading, queryClient }) {
	...
	const handleUpload = async (e) => {
		...
		try {
			...
			await uploadMediaInChunks({
				...
				category,
				favorite,
				onProgress: (pct) => setUploadProgress(30 + Math.round(pct * .7))
			});
	...
	const handleDrop = (e) => {
		...
		if (e.dataTransfer.files && e.dataTransfer.files[0]) {
			...
			} else toast.error("Please drop an image file (JPEG, PNG, WEBP, GIF)");
		}
	};
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h3", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
					...
					children: "Image File (Select, Drag & Drop, or Paste Ctrl+V)"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					onDragOver: (e) => {
						e.preventDefault();
						setIsDragging(true);
					...
					onDrop: handleDrop,
					className: cn("relative border-2 border-dashed rounded-2xl p-4 text-center transition-all bg-surface/30", isDragging ? "border-primary bg-primary/10" : "border-border hover:border-primary/50", previewUrl ? "p-3" : "py-6"),
					children: [previewUrl ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "flex items-center gap-3",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "size-20 shrink-0 rounded-xl overflow-hidden border border-border bg-black/20 relative",
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										...
										children: file?.name || "Pasted Image"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "text-[11px] text-muted-foreground mt-0.5",
										children: file ? `${(file.size / 1024).toFixed(0)} KB` : ""
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
										className: "text-[10px] text-primary/80 mt-1 flex items-center gap-1",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Sparkles, { className: "size-3" }), " Auto-optimizes on upload"]
									})
								]
							}),
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "size-10 rounded-full bg-primary/10 flex items-center justify-center text-primary mb-1",
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
								...
								children: [
									"Tip: You can also copy any image and press ",
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "font-mono bg-secondary/80 px-1 py-0.5 rounded text-foreground",
										children: "Ctrl+V"
									}),
									" to paste"
								]
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					...
					children: uploading ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoaderCircle, { className: "size-4 animate-spin" }), uploadProgress !== null ? `Uploading (${uploadProgress}%)...` : "Uploading..."] }) : "Upload Photo"
				})
			]
		})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
	...
	const handleUpload = async (e) => {
		...
		try {
			...
			if (coverFile) {
				...
				if (coverRes && coverRes.fileId) coverFileId = coverRes.fileId;
			}
			await uploadMediaInChunks({
				file,
				type: "song",
...
function TimelineManager({ timeline, isLoading, queryClient }) {
	...
	const handleUpload = async (e) => {
		...
		try {
			...
			const payload = await readJsonResponse(res);
			if (!payload.ok) throw new Error(payload.error || "Creation failed");
...
function FunZoneManager({ queryClient }) {
	...
	const handleStageFileUpload = async (stageNum, e) => {
		...
		try {
			...
			const payload = await readJsonResponse(res);
			if (!payload.ok) throw new Error(payload.error || "Failed to upload stage image");
