...
export function formatUploadError(error: string | null, fallback = "Upload failed") {
  ...
  if (lower.includes("request entity too large") || lower.includes("413")) {
    return "The uploaded file is too large for the current upload method. Please try a smaller file.";
  }
